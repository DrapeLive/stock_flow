        ...
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl font-black text-gray-900 leading-tight">Create Order</h1>
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Step 1: Select Customer</p>
            </div>
          </div>
          <button 
            onClick={() => router.push("/")}
