    ...
    <>
      <div className="border-t border-gray-100 pt-6 mt-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 active:scale-[0.98] transition-all mb-3"
        >
        ...
        {selectedItemIds.length > 0 && (
          <div className="bg-gray-100/50 p-1.5 flex items-center space-x-1 border border-gray-200 rounded-full mb-4">
            <button
