...
const Dispatched: React.FC = () => {
  ...
  if (loading) return <p className="text-center py-10 text-gray-400 font-medium">Loading dispatched orders...</p>;
      ...
      <div className="pt-2 flex justify-between items-center px-2 mb-4">
        <div className="flex gap-2 items-center">
          ...
          <div className="bg-green-100 text-green-600 rounded-full py-0.5 px-3 border border-green-200">
            <span className="font-bold text-xs">{dispatched.length}</span>
          </div>
        </div>
