...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      debugPrint('[Profile] _loadProfile failed: $e');
    }
  }
...
return Scaffold(
    ...
    return ListView(
      ...
      children: [
        ...
        if (_archivedItems.isEmpty)
          ...
          ..._archivedItems.map((item) => _archivedItemCard(item)),
        const SizedBox(height: 20),
  ...
  Widget _archivedItemCard(Item item) {
    final expanded = _expandedItem == item.id;
    final thumbnail = item.variants.isNotEmpty ? item.variants.first.image : null;
    return Container(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(14),
        onTap: () => setState(
            () => _expandedItem = expanded ? null : item.id),
        child: Column(
          children: [
            Padding(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        '${order.totalSets} sets Â· ${order.createdAt}',
                        style: const TextStyle(
